...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # The first argument in the block takes the initial value passed to inject, which later becomes the accumulated result.
  end
  ...
  #   # code to read 'file'
  #
  # The file in the first example is placed into a block as an argument and automatically closes when the block is done executing.
  # In the second example, the file stays open forever unless it is explicitly closed.
