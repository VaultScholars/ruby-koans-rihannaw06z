...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Never; it always matches (even if it's zero characters).
  end
  ...
  #
  # Why?
  # It tries to match as many characters as possible before checking the rest of the pattern.
  ...
  # In a character class, any one of the characters can match at that position.
  # With alternation, the entire sequence on either side of the | must match.
